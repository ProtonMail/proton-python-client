...
# This file was fetched from https://github.com/ActiveState/appdirs as main tweak
# was needed to be made for the Linux path
...
class AppDirs(object):
    ...
    def site_config_dir(self):
        return site_config_dir(self.appname, self.appauthor,
                             version=self.version, multipath=self.multipath) # noqa
